...
python -m pytorch_fid $experiment_dir/p2/inference/0050000 $FFHQ_DIR
python -m pytorch_fid $experiment_dir/min_snr/inference/0050000 $FFHQ_DIR
python -m pytorch_fid $experiment_dir/lognorm/inference/0050000 $FFHQ_DIR
python -m pytorch_fid $experiment_dir/clts/inference/0050000 $FFHQ_DIR
